...
import com.crm.app.repo.OpportunityRepo;
...
public class OpportunityServiceImpl implements OpportunityService {
    private final OpportunityRepo opportunityRepository;
    private final LeadTrackingService leadTrackingService;
    private final OpportunityLabelService opportunityLabelService;

    public OpportunityServiceImpl(OpportunityRepo opportunityRepository, LeadTrackingService leadTrackingService, OpportunityLabelService opportunityLabelService) {
